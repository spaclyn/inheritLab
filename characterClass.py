...
class Character:                        #Character Class Defintion
    ...
    def __str__(char):                      #STR definition
        return "My Favorite Character is: " + char.charaName + ". " + "They are " + str(char.gender) + " and " + str(char.age) + " years old. " + "I personally find them this hot: " + str(char.hotness) + "%." + str(char.mediaType);
